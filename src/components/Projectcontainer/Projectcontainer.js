...
const Projectcontainer = () => {
  ...
  return (
    <Element className="projectcontainer" id="projects">
      ...
      <p>
        {" "}
        There are some projects that I have successfully completed using the
        following tools: HTML, CSS, JavaScript, Bootstrap, React.js, as well as
        backend processing with PHP and MySQL{" "}
      </p>
      <div
        className="projectcontainer__projects"
